...
from app.pkg.model.ORM import Email as EmailModel, Log as LogModel, Type as ModelType
from app.pkg.dto.DataClass import EmailDTO, LogDTO, Type as DTOType, Status as DTOStatus
